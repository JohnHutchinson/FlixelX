package com.rubberduckygames.flixelx.data
{
	...
	public class FlxSaveWrapper
	{
		 ...
		 * I recommend using reverse domain name notation (ie com.rubberduckygames.gamename).
		 * 
		 * @param onCreatedNew this function is called in the event that a save file by the requested name was not found.
		 * That function is where you set your default values for your save data.
		 * 
		 * @param onLoaded if provided, this function is called in the event that the save file was found and correctly loaded.
		 * **/
